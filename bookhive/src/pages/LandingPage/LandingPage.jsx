            ...
            <div className="landingpage__container">
                ...
                <div className="landingpage__info">
                    ...
                    <div className="landingpage__buttons">
                        <button className="landingpage__button landingpage__button--login"><h3>LogIn</h3></button>
                        <p className="landingpage__text landingpage__text--buttons">OR</p>
                        <button className="landingpage__button landingpage__button--signup"><h3>SignUp</h3></button>
                    </div>
                </div>
            </div>
